...
public class Match
{
    ...
    public Match(final Player p1, final Player p2)
    {
        ...
        this.p1 = p1;
        this.p2 = p2;
        final Coordinate p1Coord = new Coordinate(Setting.ARENA_WIDTH/5, Setting.ARENA_HEIGHT/2);
        final Coordinate p2Coord = new Coordinate(4*(Setting.ARENA_WIDTH/5), Setting.ARENA_HEIGHT/2);
     ...
     * @return -1 both players die, 1 first player dies, 2 first player dies, 0 no collsion.
     */
